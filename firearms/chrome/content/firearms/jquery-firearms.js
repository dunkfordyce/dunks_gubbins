 ...
 *
 * Date: Wed Feb 10 16:40:48 2010 -0500
 */
function install_firearms( window, undefined ) {
try{
...
(function() {
	...
	//jQuery.support.submitBubbles = true; //eventSupported("submit");
	//jQuery.support.changeBubbles = true: //eventSupported("change");
...
window.dlog('setting', window);
window.firearms = jQuery;

}catch(e) {
    window.dlog(e);
}
window.dlog('done', window);
}
